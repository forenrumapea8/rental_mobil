...
public class HakAksesPanel extends JPanel implements Refreshable {
    ...
    private javax.swing.JLabel lblRole, lblNama, lblUsername, lblPassword, lblNoHP, lblAlamat, lblStatus, lblCari;
    ...
    public HakAksesPanel(){
        ...
        role.setModel(new DefaultComboBoxModel<String>(new String[]{"Admin","Petugas"}));
    ...
    private void initComponents() {
        ...
        lblTitle = new JLabel("Mengatur Hak Akses User");
        add(lblTitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 18, 500, 28));
        lblRole = new JLabel("Role");
        add(lblRole, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 64, 140, 22));
        add(role, new org.netbeans.lib.awtextra.AbsoluteConstraints(168, 60, 180, 26));
        lblNama = new JLabel("Nama");
        add(lblNama, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 64, 140, 22));
        add(nama, new org.netbeans.lib.awtextra.AbsoluteConstraints(508, 60, 180, 26));
        lblUsername = new JLabel("Username");
        add(lblUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 64, 100, 22));
        add(username, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 60, 170, 26));
        lblPassword = new JLabel("Password");
        add(lblPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 104, 140, 22));
        add(password, new org.netbeans.lib.awtextra.AbsoluteConstraints(168, 100, 180, 26));
        lblNoHP = new JLabel("No HP");
        add(lblNoHP, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 104, 140, 22));
        add(nohp, new org.netbeans.lib.awtextra.AbsoluteConstraints(508, 100, 180, 26));
        lblAlamat = new JLabel("Alamat");
        add(lblAlamat, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 104, 100, 22));
        add(alamat, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 100, 170, 26));
        lblStatus = new JLabel("Status");
        add(lblStatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 144, 140, 22));
        add(status, new org.netbeans.lib.awtextra.AbsoluteConstraints(168, 140, 180, 26));
        lblCari = new JLabel("Cari");
        add(lblCari, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 144, 140, 22));
        add(cari, new org.netbeans.lib.awtextra.AbsoluteConstraints(508, 140, 180, 26));
        btnSave = new JButton("Simpan User");
        add(btnSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 192, 110, 28));
        btnDelete = new JButton("Hapus User");
        add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(138, 192, 100, 28));
        btnReset = new JButton("Reset");
        add(btnReset, new org.netbeans.lib.awtextra.AbsoluteConstraints(246, 192, 80, 28));
        btnCari = new JButton("Cari");
        add(btnCari, new org.netbeans.lib.awtextra.AbsoluteConstraints(334, 192, 70, 28));
        btnRefresh = new JButton("Refresh");
        add(btnRefresh, new org.netbeans.lib.awtextra.AbsoluteConstraints(412, 192, 90, 28));
